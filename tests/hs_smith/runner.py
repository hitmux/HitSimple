    ...
    write_json(
        artifact_root / "run-manifest.json",
        {
            ...
            "sandbox": {
                ...
                "resource_limited": sandbox.resource_limiter is not None,
                "resource_limiter": sandbox.resource_limiter,
                "resource_limit_fallback": "preexec-rlimit" if not sandbox.enabled and os.name != "nt" else None,
            },
