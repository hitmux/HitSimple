...
```bash
sudo apt install ./hitsimple_0.3.7_arm64.deb
```
...
sudo dnf install ./hitsimple-0.3.7-1.el9.aarch64.rpm
```
...
```powershell
Expand-Archive .\hitsimple-0.3.7-windows-x86_64-full.zip
cd .\hitsimple-0.3.7-windows-x86_64-full
